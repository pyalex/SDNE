            ...
            if epochs % config.display == 0:
                ...
                if config.check_reconstruction:
                    print(epochs, "reconstruction:",
                          check_reconstruction(embedding, train_graph_data, config.check_reconstruction), file=fout)
                if config.check_link_prediction:
                    print(epochs, "link_prediction:",
                          check_link_prediction(embedding, train_graph_data,
                                                origin_graph_data,
                                                config.check_link_prediction), file=fout)
